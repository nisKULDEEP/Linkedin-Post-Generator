  ...
  return (
    <>
      <div className="bg-white rounded-xl border-2 border-black shadow-[8px_8px_0px_#000] p-4 space-y-4 flex flex-col">
        ...
        <div className="border-2 border-black rounded-t-lg p-1 flex items-center space-x-1 bg-gray-50">
        ...
        <textarea
          ...
          rows={10}
          className="w-full p-3 text-sm text-gray-800 bg-white border-2 border-black border-t-0 rounded-b-lg focus:outline-none focus:ring-2 focus:ring-amber-500 resize-y flex-grow"
          placeholder="Write your post here..."
        />
        <div className="pt-2">
          <Button onClick={handlePostToLinkedIn} className="!text-base w-full" variant="primary">
      ...
      >
        {imageUrl ? (
          <p>
            Your AI graphic has been downloaded.
            <br /><br />
